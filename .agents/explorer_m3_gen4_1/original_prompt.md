...
Write your analysis to `analysis.md` in your working directory `c:/Users/Figue/Desktop/Paper Trading Antigravity/.agents/explorer_m3_gen4_1`, and provide a verified evidence chain. Then write `handoff.md` with your conclusion and send me a completion message with the path.
