...
class TestBuySmallBalance(unittest.TestCase):
    ...
    def test_buy_dust(self, mock_opt, mock_insert, mock_upsert, mock_fetch, mock_client):
        mock_fetch.return_value = {'USD': 0.000001}
